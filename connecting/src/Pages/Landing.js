...
const Landing = () => {
  ...
  const content = [
    ...
    {id: 2, text: "You are about to start a web experience. Take some time. Relax. Sit back on your chair. You didn't even notice but you have been getting closer and closer to the screen. Or maybe you are lying on your bed. Under the cover is better. If you just woke up, you should finish making yourself that cup of coffee before starting. You don't want to forget about it."},
