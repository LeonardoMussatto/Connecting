    ...
    <div style={page}>
      ...
      <main style={text}>
        ...
        <section>
          ...
          <p>
            This is a way for me to perhaps bring some more attention to how we
            perceive - or don't - the other in contemporary times. But it is
            also a way to put in act and improve my web development skills. The
            source code of this website is available on GitHub, along with a
            brief journal I kept while developing it.
          </p>
          <p>
            Feel free to reach out on GitHub. The project is still under development.
          </p>
        </section>
        </main>
        <aside style={aside}>
          <section>
            ...
            <div>
              ...
              <ul>
                <li>
                  <Link href="http://www.lobsterstudio.tv/">Lobster Studio</Link>
                </li>
                <li>
      ...
      <footer style={footer}>
        <Link isButton={true} src={GitHub} href="https://github.com/LeonardoMussatto/Connecting">GitHub Repository</Link>
      </footer>
    </div>
  )
}
